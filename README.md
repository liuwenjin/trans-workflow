...
3. 使用自然语言创建一个或多个 AI Skill，记录下每个 Skill 的唯一 ID（例如 `agent_id_0`）。  
...
```
> ⚠️ *请将示例中的 `agent_id_*` 替换为您的真实 Skill ID。*
...
欢迎任何关于 AI 工作流编排、Vibe Coding 实践、轻量化前端架构的 Issue 与 Pull Request！
